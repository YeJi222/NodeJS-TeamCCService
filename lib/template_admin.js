...
//------------------------------------------------ default HTML template -------------------------------------------------
  ...
  HTML_main:function(team_info, activity_id, activity, url, url_team_num, admin_info, alertFlag){
    ...
    if(alertFlag === "noSession"){
      ...
      if(team_info[0].background_image !== undefined && team_info[0].background_image !== null){
                    ...
                    <div class="col-lg-6 order-lg-1">
                      <div class="p-5">
                        <div style="display:grid; grid-template-columns:2fr 1fr;">
                          ...
                          <a class="btn btn-primary btn-l" style="background-color: #6281D7; box-shadow: 3px 3px 5px grey; border:none; grid-column:2;grid-row:1; margin:0px; font-weight:bold; border-radius:70px; height:60px; width:200px;  align-items: center;  display: flex; justify-content: center;" href="teamcc/activity_image">Score Card Image</a>
                        </div>
                        <br />
                        <table class="mobileTableActivity">
              ...
              <section>
                <div class="container px-5">
                  <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                      <div class="p-5">
                        <div class="main-grid-user">
                          <h2 class="display-4" style="grid-row:span 3; grid-column:1; font-weight: 500; padding-top:3rem; margin-right:10px; text-align:left;">User</h2>
                          ...
                          <form action="teamcc/url_insert" style="grid-row:2; grid-column-start:2; grid-column-end:4; text-align:center;" method="post">
                            ...
                            <input type="submit" class="bt-usertable" value="Add User Team">
                          </form>
                          <div class="main-gallery-div">
                            <a href="http://handongapp.cafe24.com/teamcc/team_gallery" class="btn btn-primary btn-xl rounded-pill a-usertable">Gallery</a>
                          </div>
                        </div>
  ...
  HTML_image_gallery:function(team_info, cc, admin_info, alertFlag){
    var head_contents = head_function();
    var foot_contents = footer_function();
        ...
        <html lang="en">
          ...
          <body id="page-top">
            ...
            <div class="middlePart">
              ...
              <section id="scroll">
                <div class="container px-5">
                  ${this.function_gallery(cc)}
                </div>
              </section>
              <div style="text-align: center">
                <a href="http://handongapp.cafe24.com/teamcc/admin_main" class="btn btn-primary btn-xl rounded-pill mt-5" style="width:180px;">BACK</a>
              </div>
              <div id="mid_container">
                <button type="button" id="modal_bt" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Modal" style="display:none;"> </button>
              </div>
  ...
  // 개발자 관리 페이지 로그인
  HTML_developerMain:function(alertFlag){
    var head_contents = head_function();
    ...
    if(alertFlag === "noSession"){
      ...
      return`
        ...
        <html lang="en">
          ...
          <body>
              <div>temp developer main page</div>
          </body>
        </html>
      `;
    }
              ...
              <div class="container px-5">
                ...
                <form action="teamcc/admin_create/create_state" method="post">
                  ...
                  <div>
                    ...
                    <input class="infoBlank" type="number" max=50 required min=1 name="team_num"></input>
                  </div><br/>
  ...
  HTML_developerLogin:function(){
    return`
      ...
      <html lang="en">
        ...
        <body>
            <!-- Background Video-->
            <video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop"><source src="assets/mp4/star.mp4" type="video/mp4" /></video>
            <!-- Masthead-->
            <div class="masthead">
  ...
  // admin login page HTML(팀장 로그인 페이지)
  HTML_login:function(){
    var head_contents = head_function();
    var footer_contents = footer_function();
    ...
    return`
      ...
      <html lang="en" style="background-color: black">
        ...
        <body id="page-top" class="backgroundCSS" >
          ...
          <!-- Header -->
          <header class="masthead text-center text-white fixedHeader" >
            <div class="middlePart">
      ...
      <html lang="en">
        ...
        <body id="page-top">
          ...
          <div id="captureBtnArea">
            <button id="captureBtn" onclick="capture();"><img src="/teamcc/assets/img/downloadIcon.png" width="40px;">Score Card Download</button>
          </div>
          <br />
...
// ----------------------- function (table, grid)  -----------------------------------------------------
  function_gallery:function(cc){
    var tag = "";
    var current_team = -1;


    for(var i = 0; i< cc.length; i ++){
      if(current_team !== cc[i].team_num){
        current_team = cc[i].team_num;
        tag +=`
          <div class="col-sm-12 mb-3 mt-3 gallery-border">
            <span class="spanCSS">Team ${cc[i].team_num}</span>
          </div>
        `;
      }
      tag +=`
        <div class="col-sm-3">
          <img class="gallery-img" id="img_${cc[i].activity_id}_${cc[i].activity_index}" src="data:${cc[i].mimetype};base64,${cc[i].image}" width="100%" height=auto onclick="modal(${cc[i].activity_id},${cc[i].activity_index})" decoding="async" loading="lazy"/>
        </div>
      `;
    }
  ...
  function_activityTable:function(activity,activity_id){
    var tag = `
      <tr>
        ...
        <th width=100px>
          <div class="thCSS" style="background-color: #354B9B;"></div>
          <div class="thTextCSS" style="background-color: #354B9B; color: white;">Duplication</div>
        </th>
        <th>
    ...
    for(var i = 0; i< activity.length; i++){
      tag +=`
        <tr>
          ...
          <td width="100px" class="tdCSS">${activity[i].activity_num}</td>
          <td class="tdCSS">
    ...
    tag += `
      <form action="teamcc/activity_insert" method="post">
        ...
        <td class="tdCSS"><input type="number" min="1" max="50" style="text-align:center; width:90%; padding:5px; border:0px; background:	#E0EBFF	; border-radius:5px;font-weight:bold;" name="num" placeholder=" 5 " required / ></td>
            ...
            <script type="text/javascript">
              function kakaoShare(url_num) {
                  ...
                  content : {
                    ...
                    imageUrl:"https://ifh.cc/g/7AV4pw.jpg", // 썸네일 같은거
                    link : {
